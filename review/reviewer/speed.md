...
**At Airship, we optimize for the speed at which a team of developers can produce
...
*   **The velocity of the team as a whole is decreased.** Yes, the individual
    ...
    new features and bug fixes for the rest of the team are delayed  as each PR
    waits for review and re-review.
